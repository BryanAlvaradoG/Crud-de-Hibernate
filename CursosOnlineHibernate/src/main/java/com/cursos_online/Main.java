...
static SessionFactory sessionFactory = new MetadataSources( registry ).buildMetadata().buildSessionFactory();
	...
	public static void main(String[] args) {
			...
			Curso cur2= new Curso("Fundamentos de Programacion");
			Curso cur3= new Curso("Ingles 4");
			Curso cur4= new Curso("Redes e Informatica");
			...
			Estudiante es1 = new Estudiante(0, "Bryan", "Alvarado");
			Estudiante es2 = new Estudiante(0, "Ronald", "Rosado");
			Estudiante es3= new Estudiante(0, "Katherine", "Armijos");
			...
			//Modificar 
			modificarEstudiante(5, "Susana","Ramos" );
